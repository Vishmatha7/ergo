...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="/index">érgo</a>
       ...
       <!-- <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Projects">
        ...
        <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseProjects" data-parent="#exampleAccordion">
          ...
          <ul class="sidenav-second-level collapse" id="collapseProjects">
            <li>
              <a href="/createProjects">Create Projects</a>
            </li>
            <li>
    ...
    <div class="container">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-3">
                <div class="card">
                  <img src="{{URL::to('/')}}/mickey.png" class="card-img-top img-fluid">
                    <div class="card block">
                      <h3 class="card -title">TechKnights 123</h3>
                        <p>defgywegfy8ewevyuwgvfuywtvfguwtye efgvrwegfywefweuheuyw fgweyyefgw</p>
                    </div>
                  </div>
              </div>
              <div class="col-md-6 col-lg-3">
